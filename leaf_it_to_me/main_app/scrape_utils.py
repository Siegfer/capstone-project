...
URL_pages = "https://permapeople.org/search?page=2&sort=name_asc"
...
# routes = scrape_for_all_plant_routes(URL)
# print(json.dumps(scrape_plant_details(routes)))
test = [
    "/plants/thermopsis-villosa-aaron-s-rod",
    "/plants/brassica-oleracea-var-alboglabra-gai-lan",
]
# print(scrape_plant_details(test))
scrape_all_pages(1, 3, "test_scrape_dump.json")
